...
model4.3 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                   ...
                   data = na.omit(finaldataset_noagegender),
                   control = gamlss.control(n.cyc = 100))
#15 iterations, AIC = 121188 -> BEST MODEL
