...
#### No interaction effects have to be added -> use model 3.10 ####
...
model3.10bis3 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                          part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                          hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
...
model3.10sigma <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                          part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                          hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                          pvc(day_number, by = part_vacc:part_symp_none)+
                          re(random = ~1|part_uid),
...
model3.10sigmabis <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                             part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                             hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                             pvc(day_number, by = part_vacc:part_symp_none)+
                             re(random = ~1|part_uid),
...
model4.4sigmabis <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                           ...
                           sigma.formula = ~part_social_group_be+part_vacc+part_elevated_risk+
                             part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                             hhsize_cat+wavecount+pb(day_number)+
                             re(random = ~1|part_uid), 
                           family = NBI, 
                           data = na.omit(finaldataset_noagegender),
                           control = gamlss.control(n.cyc = 100))
