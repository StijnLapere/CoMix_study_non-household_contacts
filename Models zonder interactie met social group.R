...
model4.4 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                   ...
                   data = na.omit(finaldataset_noagegender),
                   control = gamlss.control(n.cyc = 50))
#35 iterations, AIC = 121145 <- BEST MODEL
...
model5.1 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_social_group_be*part_vacc+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.2 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_vacc*part_elevated_risk+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.3 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_vacc*part_face_mask+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.4 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_vacc*area_3_name+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.5 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_vacc*adult_cat+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.6 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_elevated_risk*part_face_mask+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.7 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_elevated_risk*adult_cat+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.8 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                     part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                     hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                     part_vacc*part_symp_none+part_face_mask*part_symp_none+pvc(day_number, by = part_vacc:part_symp_none)+
                     re(random = ~1|part_uid),
                   sigma.formula = ~1, 
                   family = NBI, 
                   data = na.omit(finaldataset_noagegender),
...
model5.9 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                      part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                      hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                      part_vacc*part_symp_none+part_face_mask*area_3_name+pvc(day_number, by = part_vacc:part_symp_none)+
                      re(random = ~1|part_uid),
                    sigma.formula = ~1, 
                    family = NBI, 
                    data = na.omit(finaldataset_noagegender),
...
model5.10 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                      part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                      hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                      part_vacc*part_symp_none+holiday*wd+pvc(day_number, by = part_vacc:part_symp_none)+
                      re(random = ~1|part_uid),
                    sigma.formula = ~1, 
                    family = NBI, 
                    data = na.omit(finaldataset_noagegender),
...
#### No interaction effects have to be added ####



#See if elevated risk can be excluded (only nonsignificant main effect)

model4.4noelevrisk <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+
         part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
         hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
         part_vacc*part_symp_none+pvc(day_number, by = part_vacc:part_symp_none)+
         re(random = ~1|part_uid),
...
model4.4bis1 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                         part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                         hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                         part_vacc*part_symp_none+pvc(day_number)+
                         re(random = ~1|part_uid),
                       sigma.formula = ~1, 
                       family = NBI, 
                       data = na.omit(finaldataset_noagegender),
...
model4.4bis2 <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                         part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                         hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                         part_vacc*part_symp_none+cs(day_number)+
                         re(random = ~1|part_uid),
                       sigma.formula = ~1, 
                       family = NBI, 
                       data = na.omit(finaldataset_noagegender),
...
model4.4sigma <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                          part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                          hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                          part_vacc*part_symp_none+pvc(day_number, by = part_vacc:part_symp_none)+
                          re(random = ~1|part_uid),
...
model4.4sigmabis <- gamlss(num_nonhouseh_cont ~ part_social_group_be+part_vacc+part_elevated_risk+
                             part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                             hhsize_cat+wavecount+area_3_name*holiday+part_face_mask*adult_cat+
                             part_vacc*part_symp_none+pvc(day_number, by = part_vacc:part_symp_none)+
                             re(random = ~1|part_uid),
                           sigma.formula = ~part_social_group_be+part_vacc+part_elevated_risk+
                             part_face_mask+part_symp_none+area_3_name+holiday+adult_cat+wd+
                             hhsize_cat+wavecount+pvc(day_number)+
                             re(random = ~1|part_uid), 
                           family = NBI, 
                           data = na.omit(finaldataset_noagegender),
                           control = gamlss.control(n.cyc = 100))
